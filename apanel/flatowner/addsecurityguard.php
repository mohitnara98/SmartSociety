...
move_uploaded_file($tmp,$path);
    ...
    header('Content-Type: application/json');
        ...
        if($con->query("insert into `flatowner`(`password`,`name`,`dateofbirth`,`mobilenumber`,`email`,`roles`,`image`) values('$passwords','$names','$dateofbirth',$mobilenumber,'$emailid','$roles','$path')")){
            header('Content-Type: application/json');
